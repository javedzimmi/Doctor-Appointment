    ...
    for (let i = 0; i < 7; i++) {
      ...
      while (currentDate < endTime) {
        timeSlots.push({
          ...
          time: currentDate.toLocaleString([], { hour: '2-digit', minute: '2-digit' }),
        });
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center p-6">
      ...
      <div className="w-full max-w-5xl mt-8 p-6 bg-white rounded-lg shadow-lg">
        ...
        <button
          className={`mt-6 px-6 py-3 rounded-md text-white font-semibold ${
            selectedTime ? 'bg-green-500 hover:bg-green-600' : 'bg-gray-400 cursor-not-allowed'
          }`}
